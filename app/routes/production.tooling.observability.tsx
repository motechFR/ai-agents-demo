...
export default function ProductionToolingObservability() {
  const observabilityImages: SliderImage[] = [
    {
      src: "/images/ai-in-prod/01-observability.png",
      alt: "AI Observability in Production",
      caption: "Monitoring, logging, and performance tracking for production AI systems"
    }
  ];
